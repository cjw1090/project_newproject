...
public class GEDrawingPanel extends JPanel{
	...
	public void rotater() {
		String degree = JOptionPane.showInputDialog(null, "회전 각도를 입력해주세요");
		double degree2 = Double.parseDouble(degree);
		double theta = Math.toRadians(degree2);
		
		transformer = new GERotater(selectedShape);
		((GERotater) transformer).rotater(theta, (Graphics2D)getGraphics() );
		addHistory();
		repaint();
	}
